...
[ 40,"It is|a consistent that JFK is|g a|r Kennedy and JFK is|g part|f of the Kennedy|a family"],
[ 41,"It is|a contradictory that JFK is|g a|r Kennedy and JFK is|g not part|f of the Kennedy|a family"],
[ 42,"It is|a contradictory that JFK is|g not a|r Kennedy and JFK is|g part|f of the Kennedy|a family"],
[ 43,"It is|a contradictory that JFK is|g a|r Kennedy and JFK is|g not part|f of the Kennedy|a family"],
[ 44,"It is|a consistent that something is|g a|r cake and cake is|g a|r class"],
[ 45,"It is|a contradictory that something is|g a|r cake and cake is|g not a|r class"],
...
[ 50,"It is|a consistent that the|r concept|n cat is|g not a|r cat"],
[ 51,"It is|a contradictory that the|r concept|n cat is|g itself|r a|r cat"],
...
[ 91,"It is|a consistent that Russell has|c|r the|r causal role 'can hit' and the|r causal role 'can hit' is|g a|r property|n"],
[ 92,"It is|a contradictory that Russell has|c|r the|r causal role can hit and the|r causal role can hit is|g not a|r property|n"],
...
[ 98,"It is|a contradictory that Plato has|t the same teacher as Xenothon and Xenothon does not have|t a teacher"],
[ 99,"It is|a consistent that Plato has|t the same teacher as Xenothon and that|d teacher is Socrates and Socrates teaches Xenothon"],
[ 100,"It is|a contradictory that Plato has|t the same teacher as Xenothon and that|d teacher is Socrates and Socrates does not teach Xenothon"],
[ 101,"It is|a consistent that I saw the same movie as you and that|d movie was Casablanca and I saw Casablanca"],
[ 102,"It is|a contradictory that I saw the same movie as you and that|d movie was Casablanca and I did not see Casablanca"],
[ 103,"It is|a consistent that Leibniz and|c Aristotle ate from the same cake and this|n was that|d cake and Leibniz ate from this|n"],
[ 104,"It is|a contradictory that Leibniz and|c Aristotle ate from the same cake and this|n was that|d cake and Leibniz did not eat from this|n"],
[ 105,"It is|a consistent that every part|p of the large house is|a white and the door is|g a|r part|p of the large house and the door is|a white"],
[ 106,"It is|a contradictory that every part|p of the large house is|a white and the door is|g a|r part|p of the large house and the door is|a not white"],
[ 107,"It is|a contradictory that no part|p of the large house is|a white and the door is|g a|r part|p of the large house and the door is|a white"],
[ 108,"It is|a consistent that I saw everyone who drank something in the van and Leibniz drank something in the van and I saw Leibniz"],
[ 109,"It is|a contradictory that I saw everyone who drank something in the van and Leibniz drank something in the van and I did not see Leibniz"],
[ 110,"It is|a consistent that I love nothing which is|r about murder and Hamlet is|r about murder and I do not love Hamlet"],
[ 111,"It is|a contradictory that I love nothing which is|r about murder and hamlet is|r about murder and I love Hamlet"],
[ 112,"It is|a consistent that I love anything which is|r about logic and set theory is|r about logic and I love set theory"],
[ 113,"It is|a contradictory that I love anything which is|r about logic and set theory is|r about logic and I do not love set theory"],
[ 114,"It is|a consistent that no green man from|b cold Mars, lives on|r Earth and Jim is|g a|r green man born|p on|r Mars and Jim does not live on|r Earth"],
[ 115,"It is|a contradictory that no green man from|b cold Mars, lives on|r Earth and Jim is|g a|r green man born|p on|r Mars and Jim lives on|r Earth"],
[ 116,"It is|a consistent that every green man from|b Mars drinks and Jim is|g a|r green man born|p on|r Mars and Jim drinks"],
[ 117,"It is|a contradictory that every green man from|b Mars drinks and Jim is|g a|r green man born|p on|r Mars and Jim does not drink"],
[ 118,"It is|a consistent that everyone who spies on Leibniz, will|r be|a rewarded and Russell spied on Leibniz and Russell was|a rewarded"],
[ 119,"It is|a contradictory that everyone who spies on Leibniz, will|r be|a rewarded and Russell spied on Leibniz and Russell was|a not rewarded"],
[ 120,"It is|a consistent that everyone who spies on a nazi in Munich, will|r be|a rewarded and Russell spied on a nazi in Munich and Russell was|a rewarded"],
[ 121,"It is|a contradictory that everyone who spies on a nazi in Munich, will|r be|a rewarded and Russell spied on a nazi in Munich and Russell was|a not rewarded"],
[ 122,"It is|a consistent that anyone who breaks the speed limit, will|r be|a caught and Marilyn broke the speed limit and Marilyn was|a caught"],
[ 123,"It is|a contradictory that anyone who breaks the speed limit, will|r be|a caught and Marilyn broke the speed limit and Marilyn was|a not caught"],
...
[ 126,"It is|a consistent that every woman at|c the party drank and Jessica was|r at|c the party and Jessica is|g a|r woman and Jessica drank"],
[ 127,"It is|a contradictory that every woman at|c the party drank and Jessica was|r at|c the party and Jessica is|g a|r woman and Jessica did not drink"],
[ 128,"It is|a consistent that every woman at|c the party drank and Jessica was|g a|r woman at|c the party and Jessica drank"],
[ 129,"It is|a contradictory that every woman at|c the party drank and Jessica was|g a|r woman at|c the party and Jessica did not drink"],
[ 130,"It is|a consistent that no part|p of the large house is|a white and the door is|g a|r part|p of the large house and the door is|a not white"],
[ 131,"It is|a consistent that I love everyone who reads Leibniz and Russell reads Leibniz and I love Russell"],
[ 132,"It is|a contradictory that I love everyone who reads Leibniz and Russell reads Leibniz and I do not love Russell"],
...
# [ 179,"It is|a contradictory that this wrinkle in that|d carpet is|g not an|r individual|a thing"],
# [ 180,"It is|a consistent that this wrinkle in that|d carpet is|g an|r individual|a thing"],
# [ 181,"It is|a consistent that a number|i is|a a|r universal"],
# [ 182,"It is|a contradictory that a number|i is|a not a|r universal"],
# [ 183,"It is|a contradictory that a universal is|a wholly present in space"],
# [ 184,"It is|a consistent that no universal is|a wholly present in space"],
# [ 185,"It is|a consistent that a set of particles has the quality 'being a man'"],
# [ 186,"It is|a consistent that a set of particles does not have the quality 'being a man'"],
# [ 187,"It is|a consistent that a particular is|g something that|r instantiates"],
# [ 188,"It is|a contradictory that a particular is|g something that|r does not instantiate"],
# [ 189,"It is|a consistent that a particular is|r not itself|r instantiated"],
# [ 190,"It is|a contradictory that a particular is|r instantiated"],
# [ 191,"It is|a consistent that a universal has|m an|r instance"],
# [ 192,"It is|a contradictory that a universal does not have|m an|r instance"],
# [ 193,"It is|a consistent that this apple is|a real|p and this apple is|a imaginary to Leibniz"],
# [ 194,"It is|a contradictory that this apple is|a not real|p and this apple is|a imaginary to Leibniz"],
# [ 195,"It is|a contradictory that this apple is|a real|p and this apple is|a fictional to Leibniz"],
# [ 196,"It is|a consistent that this apple is|a not real|p and this apple is|a fictional to Leibniz"],
# [ 197,"It is|a contradictory that this apple is|a fictional to Aristotle and this apple is|a imaginary to Aristotle"],
# [ 198,"It is|a consistent that this apple is|a not fictional to Aristotle and this apple is|a imaginary to Aristotle"]]
    return sent, 468