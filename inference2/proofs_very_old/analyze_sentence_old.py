from general_functions_old import mainconn, findposinmd, remove_outer_paren, ErrorWithCode
        ...
        while x < l - 1:
            ...
            if sentence[x:x + 1] == "(":
                if not unenclose_at_end:
                    unenclose_at_end = is_natural_language_old(sentence, x)
...
def is_natural_language_old(sentence, i):
