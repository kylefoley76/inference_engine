...
<head>
    ...
    <title>Coverage for /Library/Python/2.7/site-packages/openpyxl/comments/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/Library/Python/2.7/site-packages/openpyxl/comments/__init__.py</b> :
...
<p id="t5" class="stm run hide_run"><span class="key">from</span> <span class="op">.</span><span class="nam">comments</span> <span class="key">import</span> <span class="op">*</span><span class="strut">&nbsp;</span></p>
